...
const skills = [
  ...
  { name: "API REST", level: 75, category: "backend" },
  { name: "MongoDB", level: 70, category: "backend" },
  { name: "Firestore", level: 70, category: "backend" },
  ...
  { name: "Elasticsearch", level: 70, category: "tools" },
  { name: "Figma", level: 85, category: "tools" },
  { name: "Canva", level: 85, category: "tools" },
  { name: "Jira", level: 85, category: "tools" },
  { name: "Confluence", level: 85, category: "tools" },
...
const categories = [
  ...
  { key: "frontend", label: "categories.frontend" },
  { key: "backend", label: "categories.backend" },
